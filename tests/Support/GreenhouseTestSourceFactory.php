...
final class GreenhouseTestSourceFactory
{
    /**
    ...
    public static function create(string $name, string $siteSlug, array $configOverrides = []): JobSource
    {
        return JobSource::query()->create([
            'name' => $name,
            'base_url' => 'https://boards-api.greenhouse.io/v1/boards/'.$siteSlug.'/jobs',
    ...
    {
        $path = base_path('tests/Fixtures/Scraper/greenhouse/'.$filename);
